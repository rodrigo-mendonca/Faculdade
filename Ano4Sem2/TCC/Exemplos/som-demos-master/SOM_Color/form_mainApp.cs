...
namespace SOM_Color {
    ...
    public class SOM_Color_Form : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SOM_Color_Form));
            ...
            0,
            0});
            this.numericUpDown_Iterations.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.numericUpDown_NumRandomColors.Maximum = new decimal(new int[] {
            20,
            0,
            0,
            0});
            this.numericUpDown_NumRandomColors.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.numericUpDown_NumRandomColors.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
